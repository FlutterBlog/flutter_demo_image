...
class ImagePage extends StatefulWidget {
  ...
  static ExamplePage createPage() {
    return ExamplePage(Icons.image, (context) => const ImagePage());
  }
...
class ImageListPage extends StatelessWidget {
  ...
  static ExamplePage createPage() {
    return ExamplePage(Icons.list, (context) => const ImageListPage());
  }
...
class ImageGridPage extends StatelessWidget {
  ...
  static ExamplePage createPage() {
    return ExamplePage(Icons.grid_on, (context) => const ImageGridPage());
  }
